...
run_experiment() {
    ...
    while [ $i -le $num_runs ]; do
        ...
        $PYTHON_BIN train.py \
            ...
            --num_workers 8 \
            --prefetch_factor 4 \
            --subspace_type "Q-A-A-A-A-Q-Q-Q-Q-Q" \
...
# run_experiment "Experiment 2: 500 samples, 4096 steps, batch_size 64" 500 4096 64 12
run_experiment "Experiment 3: 5000 samples, 4096 steps, batch_size 128" 5000 4096 128 10
