...
run_experiment() {
    ...
    while [ $i -le $num_runs ]; do
        ...
        $PYTHON_BIN train.py \
            ...
            --num_workers 8 \
            --prefetch_factor 4 \
            --subspace_type "Q-A-A-A-A-Tr-Tr-Tr-Tr-Q" \
...
# run_experiment "Experiment 1: 50 samples, 1024 steps, batch_size 16" 50 1024 16 16
# run_experiment "Experiment 2: 500 samples, 4096 steps, batch_size 64" 500 4096 64 10
run_experiment "Experiment 3: 5000 samples, 4096 steps, batch_size 128" 5000 4096 128 9
