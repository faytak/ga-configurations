...
run_experiment() {
    ...
    # Slug for run_name: replace spaces with underscores
    local run_slug="${exp_name// /_}"
...
# run_experiment "TT_A: 128 train, 1000 steps, bs32" 128 1000 32 "$NUM_RUNS"

run_experiment "TT_A: 256 train, 1000 steps, bs32" 256 1000 32 10

# Mid-size
# run_experiment "TT_A: 512 train, 1000 steps, bs32" 512 1000 32 "$NUM_RUNS"

# Large / long runs (inspired by full_Q_TT_Nruns.sh which uses long schedules)
run_experiment "TT_A: 1024 train, 3000 steps, bs32" 1024 3000 32 5
