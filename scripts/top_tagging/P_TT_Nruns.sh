...
# run_experiment "TT_P: 128 train, 1000 steps, bs32" 128 1000 32 "$NUM_RUNS"
run_experiment "TT_P: 256 train, 1000 steps, bs32" 256 1000 32 10
# run_experiment "TT_P: 512 train, 1000 steps, bs32" 512 1000 32 "$NUM_RUNS"

# Large / long-ish
run_experiment "TT_P: 1024 train, 3000 steps, bs32" 1024 3000 32 5
